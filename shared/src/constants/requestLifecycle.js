 ...
 */
export const ORDERED_REQUEST_STATUSES = [
    "pending",
    "location_routed",
    "ngo_assigned",
    "ngo_accepted",
...
export const STATUS_GROUPS = {
    ...
    terminal: ["completed", "resolved", "rejected", "closed"],
};
/**
 * Statuses from which a user/citizen can safely delete a request
 */
export const DELETEABLE_STATUSES = [
    "pending",
 ...
 */
export function canDeleteRequest(status) {
